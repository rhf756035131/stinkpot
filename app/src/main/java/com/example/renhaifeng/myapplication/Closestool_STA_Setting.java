 ...
 */
public class Closestool_STA_Setting extends AppCompatActivity {
    private static final String TAG = "Closestool PA Setting";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.closestool_sta_setting);
        ...
        mBtnConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new StatusTask(Closestool_STA_Setting.this, "Query Status").execute();
            }
