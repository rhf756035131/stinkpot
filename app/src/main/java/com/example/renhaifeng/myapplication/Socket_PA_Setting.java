 ...
 */
public class Socket_PA_Setting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.socket_pa_setting);
        ...
        mBtnConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new StatusTask(Socket_PA_Setting.this, "Query Status").execute();
            }
