 ...
 */
public class Closestool_PA_Setting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.closest_pa_setting);
        ...
        mBtnConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new StatusTask(Closestool_PA_Setting.this, "Query Status").execute();
            }
